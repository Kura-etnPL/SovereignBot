...
const inspectReplyOnly = process.argv.includes("--inspect-reply-only");
if (inspectReplyOnly && resumeAt < 0) throw new Error("Reply-only inspection requires an existing run");
...
const env = {
    ...
    SOVEREIGNBOT_INSPECT_REPLY_ONLY: inspectReplyOnly ? "1" : "0",
