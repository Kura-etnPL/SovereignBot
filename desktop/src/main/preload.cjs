...
contextBridge.exposeInMainWorld("sovereignbot", Object.freeze({
    ...
    routines: Object.freeze({ create: invoke("routine:create"), list: invoke("routine:list"), get: invoke("routine:get"), history: invoke("routine:history"), runNow: invoke("routine:runNow"), setEnabled: invoke("routine:setEnabled"), remove: invoke("routine:remove") }),
