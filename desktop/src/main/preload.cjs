...
contextBridge.exposeInMainWorld("sovereignbot", Object.freeze({
    ...
    teams: Object.freeze({ list: invoke("team:list"), get: invoke("team:get"), installPack: invoke("team:installPack"), exportPack: invoke("team:exportPack"), importPack: invoke("team:importPack"), duplicatePack: invoke("team:duplicatePack"), editPack: invoke("team:editPack"), exportPlaybook: invoke("team:exportPlaybook"), importPlaybook: invoke("team:importPlaybook"), createChannelFromTemplate: invoke("team:createChannelFromTemplate") }),
