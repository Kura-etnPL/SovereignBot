...
function handlers(fixture) {
  ...
  return {
    ...
    "conversation:list": () => conversationStore.list(), "conversation:get": ({ conversationId }) => conversationStore.get(conversationId), "conversation:acknowledge": ({ conversationId }) => ({ resolved: false, count: 0, conversationId }),
